...
def main():
  ...
  if FLAGS.file_format == "tfrecords":
    train_dataset = tf.contrib.data.TFRecordDataset(train_filename_placeholder)
    ...
    train_dataset = tf.contrib.data.TextLineDataset(train_filename_placeholder)
  ...
  if FLAGS.file_format == "tfrecords":
    validation_dataset = tf.contrib.data.TFRecordDataset(
    ...
    validation_dataset = tf.contrib.data.TextLineDataset(
        validation_filename_placeholder)
